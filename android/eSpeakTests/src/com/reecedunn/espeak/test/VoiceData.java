...
public class VoiceData
{
    ...
    public static final Voice[] voices = new Voice[] {
        ...
        new Voice("en-au",           "gmw/en-AU",           "en",  "eng", "AU",  "AUS", "",         SpeechSynthesis.GENDER_MALE, "English (Australia)",              "eng-AUS",          "This is a sample of text spoken in English (Australia)"),
        new Voice("en-ca",           "gmw/en-CA",           "en",  "eng", "CA",  "CAN", "",         SpeechSynthesis.GENDER_MALE, "English (Canada)",                 "eng-CAN",          "This is a sample of text spoken in English (Canada)"),
        new Voice("en-in",           "gmw/en-in",           "en",  "eng", "IN",  "IND", "",         SpeechSynthesis.GENDER_MALE, "English (India)",                  "eng-IND",          "This is a sample of text spoken in English (India)"),
        new Voice("en-sg",           "gmw/en-SG",           "en",  "eng", "SG",  "SGP", "",         SpeechSynthesis.GENDER_MALE, "English (Singapore)",              "eng-SGP",          "This is a sample of text spoken in English (Singapore)"),
