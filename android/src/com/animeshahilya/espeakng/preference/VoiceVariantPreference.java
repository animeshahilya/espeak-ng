...
public class VoiceVariantPreference extends PersistingDialogPreference {
    ...
    private static final VariantData[][] variants = {
        {   // Male
            ...
            new VariantData(R.string.variant_n, 6, "f6"),
        },{ // Klatt (upstream cascade-parallel formant models)
            new VariantData(R.string.variant_klatt_1, "klatt"),
            new VariantData(R.string.variant_klatt_2, "klatt2"),
            new VariantData(R.string.variant_klatt_3, "klatt3"),
            new VariantData(R.string.variant_klatt_4, "klatt4"),
            new VariantData(R.string.variant_klatt_5, "klatt5"),
            new VariantData(R.string.variant_klatt_6, "klatt6"),
        },{ // Character voices
            ...
            new VariantData(R.string.variant_zbond_denture, "ZBondDenture"),
            new VariantData(R.string.variant_boris, "boris"),
            new VariantData(R.string.variant_bug, "bug"),
            new VariantData(R.string.variant_bug_crushed, "bugCrushed"),
            ...
            new VariantData(R.string.variant_giant_monster, "GiantMonster"),
            new VariantData(R.string.variant_giantrobot, "giantrobot"),
            new VariantData(R.string.variant_giving_instructions, "givingInstructions"),
            new VariantData(R.string.variant_giving_instructions2, "givingInstructions2"),
