...
static ucd_property properties_Po(codepoint_t c)
{
	...
	case 0x0900:
		...
		if (c == 0x0965)                return UCD_PROPERTY_TERMINAL_PUNCTUATION | UCD_PROPERTY_SENTENCE_TERMINAL | ESPEAKNG_PROPERTY_FULL_STOP | ESPEAKNG_PROPERTY_OPTIONAL_SPACE_AFTER | ESPEAKNG_PROPERTY_PARAGRAPH_SEPARATOR;
		break;
	case 0x0D00:
